...
menu.bg.pre.Text = 'SoulZ.<font color="#00fffb">cc</font> | <font color="#00fffb"> Paid </font>'
...
function library:createConfig()
    ...
    writefile("Soulz_cc/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
...
function library:refreshConfigs()
    local tbl = {}
    for i,v in next, listfiles("Soulz_cc") do
        table.insert(tbl,v)
    end
